...
public class WoodworksBlocks {
	...
	public static void setupTabEditors() {
		CreativeModeTabContentsPopulator.mod(Woodworks.MOD_ID)
				...
				.tab(NATURAL_BLOCKS)
				.addItemsAfter(of(Items.FLOWERING_AZALEA_LEAVES), OAK_LEAF_PILE, SPRUCE_LEAF_PILE, BIRCH_LEAF_PILE, JUNGLE_LEAF_PILE, ACACIA_LEAF_PILE, DARK_OAK_LEAF_PILE, MANGROVE_LEAF_PILE, CHERRY_LEAF_PILE, AZALEA_LEAF_PILE, FLOWERING_AZALEA_LEAF_PILE)
