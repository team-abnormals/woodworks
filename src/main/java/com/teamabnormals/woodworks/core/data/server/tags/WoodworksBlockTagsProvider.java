...
public class WoodworksBlockTagsProvider extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		this.tag(BlockTags.GUARDED_BY_PIGLINS).add(OAK_CHEST.get(), SPRUCE_CHEST.get(), BIRCH_CHEST.get(), JUNGLE_CHEST.get(), ACACIA_CHEST.get(), DARK_OAK_CHEST.get(), MANGROVE_CHEST.get(), CHERRY_CHEST.get(), BAMBOO_CLOSET.get(), CRIMSON_CHEST.get(), WARPED_CHEST.get(), TRAPPED_OAK_CHEST.get(), TRAPPED_SPRUCE_CHEST.get(), TRAPPED_BIRCH_CHEST.get(), TRAPPED_JUNGLE_CHEST.get(), TRAPPED_ACACIA_CHEST.get(), TRAPPED_DARK_OAK_CHEST.get(), TRAPPED_MANGROVE_CHEST.get(), TRAPPED_CHERRY_CHEST.get(), TRAPPED_BAMBOO_CLOSET.get(), TRAPPED_CRIMSON_CHEST.get(), TRAPPED_WARPED_CHEST.get());
