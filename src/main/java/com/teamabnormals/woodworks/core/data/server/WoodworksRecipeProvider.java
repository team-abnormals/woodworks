...
public class WoodworksRecipeProvider extends RecipeProvider implements IConditionBuilder {
	...
	public void buildRecipes(Consumer<FinishedRecipe> consumer) {
		...
		this.baseRecipes(consumer, Blocks.BAMBOO_PLANKS, Blocks.BAMBOO_SLAB, null, BAMBOO_BOOKSHELF.get(), CHISELED_BAMBOO_BOOKSHELF.get(), BAMBOO_LADDER.get(), BAMBOO_BEEHIVE.get(), null, null);
	...
	public void baseRecipes(Consumer<FinishedRecipe> consumer, Block planks, Block slab, Block boards, Block bookshelf, Block chiseledBookshelf, Block ladder, Block beehive, Block chest, Block trappedChest) {
		...
		if (boards != null) {
			this.conditionalRecipe(consumer, RecipeCategory.BUILDING_BLOCKS, config(COMMON.woodenBoards, "wooden_boards"), ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, boards, 3).define('#', planks).pattern("#").pattern("#").pattern("#").group("wooden_boards").unlockedBy(getHasName(planks), has(planks)));
		}
