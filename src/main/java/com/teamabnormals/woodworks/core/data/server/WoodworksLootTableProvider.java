...
public class WoodworksLootTableProvider extends LootTableProvider {
	...
	private static class WoodworksBlockLoot extends BlockLootSubProvider {
		...
		public void generate() {
			...
			this.add(SPRUCE_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(BIRCH_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(JUNGLE_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(ACACIA_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(DARK_OAK_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(MANGROVE_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(CHERRY_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(BAMBOO_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(CRIMSON_BEEHIVE.get(), this::createBeeHiveDrop);
			...
			this.add(WARPED_BEEHIVE.get(), this::createBeeHiveDrop);
		...
		public Iterable<Block> getKnownBlocks() {
			return BuiltInRegistries.BLOCK.stream().filter(block -> Woodworks.MOD_ID.equals(BuiltInRegistries.BLOCK.getKey(block).getNamespace())).collect(Collectors.toSet());
		}
	}
}